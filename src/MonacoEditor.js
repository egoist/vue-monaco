...
export default {
  ...
  mounted() {
    ...
    window.require(['vs/editor/editor.main'], () => {
      ...
      this.editor.onDidChangeModelDecorations(event => this.$emit('modelDecorations'))
      this.editor.onDidChangeModelLanguage(event => this.$emit('modelLanguage'))
      this.editor.onDidChangeModelOptions(event => this.$emit('modelOptions'))
      this.editor.onDidDispose(event => this.$emit('afterDispose'))
